...
if(isset($_POST["addevent"])){
 ...
 mysqli_query($conn,"insert into event(username,email,eventtitle,eventdesc,reminder,date) values('$fullname','$email','$eventtitle','$eventdesc','$reminder','$eventdate')");
							...
							<div class="card">
								...
								<div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="eventtitle" class="form-control"  aria-describedby="eventtitle" placeholder="Enter your first name and last name ">
                                        <small id="eventtitle" class="form-text text-muted">Enter users Fullname.</small>
                                    </div>
                                
                                    <div class="form-group">
                                        <label for="eventdescription">Event Description</label>
                                        <input type="text" name="eventdesc" class="form-control"  aria-describedby="eventdescription" placeholder="Enter email">
                                    ...
                                    <div class="form-group">
								        <button type="submit" name="addevent" class="btn btn-primary btn-block">submit <i class="icon-circle-right2 ml-2"></i></button>
							        </div>

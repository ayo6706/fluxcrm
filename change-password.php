...
$newpassword = md5(md5(md5($_POST["newpass"])));   
 $sql=mysqli_query($conn,"SELECT password FROM  customers where password='".$oldpassword."' && email='".$_SESSION['aemail']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($conn,"update  customers set password='".$newpassword."' where email='".$_SESSION['aemail']."'");
